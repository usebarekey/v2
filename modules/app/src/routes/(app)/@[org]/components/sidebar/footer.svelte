...
<footer class="flex flex-col items-center justify-center p-2.5">
    <Dropdown.Root bind:open>
        <Dropdown.Trigger class="flex h-[3lh] gap-4 w-full flex-row items-center justify-between rounded-2xl bg-background-muted px-2.5 card outline outline-background-muted outline-offset-4">
        ...
        <Dropdown.Content class="min-w-64 mb-1 flex flex-col rounded-2xl">
